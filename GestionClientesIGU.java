...
public class GestionClientesIGU extends javax.swing.JFrame 
{
     ...
     * carga el driver y conecta con la base de datos
     * obtiene el resultado y lo muestra
     */
     ...
     * ADVERTENCIA: NO modifique este código. El editor de formularios siempre 
     * regenera el contenido de este método.
     */
    ...
    /**
     * Cierra la ventana:
     * cierra el ResultSet y la conexion con la base de datos
     * @param evt. Evento
     * @throws SQLException
     */
     ...
     * Muestra el primer cliente
     * 
     * @throws SQLException. muestra la ventana de error sql
     * @throws Exception. muestr la ventana de error
     */
    ...
    /**
     * boton para mostrar la ventana de editar cliente
     * @param evt. evento
     * @throws SQLException. muestra la ventana de error
     */
    ...
    /**
     * boton para mostrar la ventana de eliminar cliente
     * @param evt. evento
     * @throws SQLException. muestra la ventana de error
     */
    ...
    /**
     * boton para mostrar la ventana de nuevo cliente
     * @param evt. evento
     */
    ...
    /**
     * boton de aceptar y insertar al nuevo cliente
     * @param evt. evento
     */
    ...
    /**
     * boton de cacelar y no registrar un nuevo cliente
     * @param evt. evento
     */
    ...
    /**
     * boton de aceptar y guardar al nuevo cliente
     * @param evt. evento
     */
    ...
    /**
     * Principal. se encarga de que se muestre la interfaz grafica
     * @param args
    ...
    public static void main(String args[]) {
        /* Establezca el aspecto y la sensación de Nimbus */
